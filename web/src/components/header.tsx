...
export function Header() {
  ...
  return (
    <Popover as="header" className="relative">
        ...
        >
          ...
          {user ? (
            <div className="hidden md:flex md:items-center md:space-x-6">
              <Link className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-violet-600 hover:bg-violet-700" href="/courses">
                Meus cursos
              </Link>
              <a className="text-base font-medium text-white hover:text-gray-300" href="/api/auth/logout">
                Sair do app
              </a>
            </div>
          ) : (
      ...
      >
        <PopoverPanel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top md:hidden">
